 ...
 * 
 * import static org.testng.Assert.assertEquals; import java.util.stream.Stream;
 ...
 *//**
	 ...
	 */
/*
 * @BeforeTest public void setUp() { isNumberPresentStream = new
 * NumberPresent(); }
 * 
 *//**
	 * First test case with is number present or not.
	 *//*
		 * @Test public void listOfIntegerStreamType() { Stream<Integer> stream =
		 * Stream.of(1, 2, 3, 4); int num = 4; assertEquals(isNumberPresentStream
